                    ...
                    <div key={m._id}>
                                 ...
                                 <div className="col-md-6">
                                     <ul className=''>
                                         ...
                                         <li className=' fw-bold'>
                                             Email: <span className='fw-bold text-primary'>{m.email}</span>
                                         </li>
                                         <li className=' fw-bold'>
                                             Customer Id: <span className='fw-bold text-primary'>{m.id1}</span>
                                         </li>
                                         <li className=' fw-bold'>
                                             Units: <span className='fw-bold text-primary'>{m.unit}</span>
                                         </li>
                                         <li className=' fw-bold'>
                                             Rate: <span className='fw-bold text-primary'>{m.rate}</span>
                                         </li>
                                     </ul>
                                 </div>
